...
const (
	...
	ChatsGone        = "Текущий чат уже удален"
	ChatsNoAction    = "Действие не найдено"
	ChatsNotFound    = "Команда не найдена"
	...
	ManagersFmt      = "Менеджеры: %s"
	ManagersAsk      = "Менеджеры:"
...
const (
	...
	GameConfigSubscribersFmt = "Подписчики: %s"
	...
	GameConfigSubscribersAsk = "Подписчики:"
)
